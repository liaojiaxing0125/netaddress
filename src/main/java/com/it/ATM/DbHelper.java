...
public class DbHelper {
    ...
    public Connection getConn() {
        try {
            System.out.println(MyProperties.getInstance().getProperty("url"));
...
//                    } else {
    ...
    public <T> List<T> finds(String sql, Class<T> cls, Object... params) throws IllegalAccessException, InstantiationException, InvocationTargetException {
